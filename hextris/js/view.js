...
function showText(text) {
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>Игра приостановлена</div>",
		'pausedAndroid': "<div class='centeredHeader unselectable'>Игра приостановлена</div>",
		'pausediOS': "<div class='centeredHeader unselectable'>Игра приостановлена</div>",
		'pausedOther': "<div class='centeredHeader unselectable'>Игра приостановлена</div>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>Нажмите Enter или  чтобы начать</div>"
	};
